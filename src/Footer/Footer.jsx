...
import { faChevronRight, faPhone, faLocationDot, faClock, faEnvelope } from '@fortawesome/free-solid-svg-icons';
import "./Footer.css";

export default function Footer() {
  return (
    <div className="container-fluid bg-black">
        <ul className="container-fluid text-white d-flex justify-content-around m-0 py-2 border-bottom border-dark">
          <li>
        ...
        <div className="row">
            <p className="copyright container-fluid text-center text-white opacity-50 text-uppercase m-0 p-0">Copyright © 2023 Pctranlaw. All rights reserved.</p>
        </div>
    </div>
  );
}
